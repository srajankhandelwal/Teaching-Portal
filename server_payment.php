...
// echo "hi". $payment_amount . $payment_method . $payment_reference_number. $personal_email. $mtech_department.$mtech_application_category. "<br>";
...
echo $mtech_application_category . $mtech_department. $personal_email;
...
echo "going";
$query = "update mtp_application_info set payment_method	 ='$payment_method', payment_reference_number	 ='$payment_reference_number', payment_amount	 ='$payment_amount', filled_payment = '$filled_payment', added_updated=NOW() where mtech_application_category ='$mtech_application_category' and mtech_department='$mtech_department' and personal_email='$personal_email'";

header("location: fill_form_education.php");
...
{
    // echo $mtech_application_category;
  // echo "Study PHP at " . $payment_method . $mtech_department . "<br>";
	// echo '<center><b>Application Form submiitted  Successfullly<br><br>Application ID:'.$app_id.'</center>';
  // 
    // <button><a href="fill_form_education.php" class="nav-link text-light pl=4">Education Info</a></button>
