        ...
        <nav class="navbar navbar-expand d-flex flex-column align-item-start" id="sidebar">
            ...
            <li class="nav-item w-100">
                ...
                <li class="nav-item w-80">
                    <h2 <?php if($filled_gate === '1'){ ?> style="background-color:green" <?php } else { ?> style="background-color:black" <?php } ?>><a href="fill_form_gate.php" class="nav-link text-light pl=4">GATE Details</a></h2>
                </li>
                <hr style="width: 100%; color: white; height: 1px; background-color:blue;" />
                    </hr>
                <li class="nav-item w-80">
                    <h2 style="background-color:orange"><a href="fill_form_work.php" class="nav-link text-light pl=4">Work Experience</a></h2>
                </li>
                <hr style="width: 100%; color: white; height: 1px; background-color:blue;" />
                    </hr>
                <li class="nav-item w-80">
