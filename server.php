...
$query = "update mtp_application_info set personal_full_name='$personal_full_name', personal_gender	 ='$personal_gender', personal_fathers_name	 ='$personal_fathers_name', personal_date_of_birth	 ='$personal_date_of_birth', personal_birth_category	 ='$personal_birth_category', personal_address	 ='$personal_address', personal_state	 ='$personal_state', personal_nationality	 ='$personal_nationality', personal_pincode	 ='$personal_pincode', personal_contact	 ='$personal_contact', personal_email	 ='$personal_email', personal_marital_status	 ='$personal_marital_status', personal_disable_status	 ='$personal_disable_status', tenth_equi_exam_passed	 ='$tenth_equi_exam_passed', tenth_equi_school_name	 ='$tenth_equi_school_name', tenth_equi_board_name	 ='$tenth_equi_board_name', tenth_equi_passing_year	 ='$tenth_equi_passing_year', tenth_equi_percentage	 ='$tenth_equi_percentage', tenth_equi_out_of	 ='$tenth_equi_out_of', tenth_equi_complete_status	 ='$tenth_equi_complete_status', tenth_equi_notes_if_any	 ='$tenth_equi_notes_if_any', inter_equi_exam_passed	 ='$inter_equi_exam_passed', inter_equi_school_name	 ='$inter_equi_school_name', inter_equi_board_name	 ='$inter_equi_board_name', inter_equi_passing_year	 ='$inter_equi_passing_year', inter_equi_percentage	 ='$inter_equi_percentage', inter_equi_out_of	 ='$inter_equi_out_of', inter_equi_complete_status	 ='$inter_equi_complete_status', inter_equi_notes_if_any	 ='$inter_equi_notes_if_any', ug_exam_passed	 ='$ug_exam_passed', ug_degree_name	 ='$ug_degree_name', ug_discipline	 ='$ug_discipline', ug_college_name	 ='$ug_college_name', ug_univeristy_name	 ='$ug_univeristy_name', ug_passing_year	 ='$ug_passing_year', ug_percentage	 ='$ug_percentage', ug_out_of	 ='$ug_out_of', ug_complete_status	 ='$ug_complete_status', ug_notes_if_any	 ='$ug_notes_if_any', pg_1_exam_passed	 ='$pg_1_exam_passed', pg_1_pg_degree_name	 ='$pg_1_pg_degree_name', pg_1_discipline	 ='$pg_1_discipline', pg_1_college_name	 ='$pg_1_college_name', pg_1_univeristy_name	 ='$pg_1_univeristy_name', pg_1_passing_year	 ='$pg_1_passing_year', pg_1_percentage	 ='$pg_1_percentage', pg_1_out_of	 ='$pg_1_out_of', pg_1_complete_status	 ='$pg_1_complete_status', pg_1_notes_if_any	 ='$pg_1_notes_if_any', pg_2_exam_passed	 ='$pg_2_exam_passed', pg_2_pg_degree_name	 ='$pg_2_pg_degree_name', pg_2_discipline	 ='$pg_2_discipline', pg_2_college_name	 ='$pg_2_college_name', pg_2_univeristy_name	 ='$pg_2_univeristy_name', pg_2_passing_year	 ='$pg_2_passing_year', pg_2_percentage	 ='$pg_2_percentage', pg_2_out_of	 ='$pg_2_out_of', pg_2_complete_status	 ='$pg_2_complete_status', pg_2_notes_if_any	 ='$pg_2_notes_if_any', other_exam_passed	 ='$other_exam_passed', other_pg_degree_name	 ='$other_pg_degree_name', other_discipline	 ='$other_discipline', other_college_name	 ='$other_college_name', other_univeristy_name	 ='$other_univeristy_name', other_passing_year	 ='$other_passing_year', other_percentage	 ='$other_percentage', other_out_of	 ='$other_out_of', other_complete_status	 ='$other_complete_status', other_notes_if_any	 ='$other_notes_if_any', work_1_experience_type	 ='$work_1_experience_type', work_1_organization_name	 ='$work_1_organization_name', work_1_position	 ='$work_1_position', work_1_from_date	 ='$work_1_from_date', work_1_to_date	 ='$work_1_to_date', work_1_experience_duration	 ='$work_1_experience_duration', work_1_nature_of_work	 ='$work_1_nature_of_work', work_1_current_job	 ='$work_1_current_job', work_2_experience_type	 ='$work_2_experience_type', work_2_organization_name	 ='$work_2_organization_name', work_2_position	 ='$work_2_position', work_2_from_date	 ='$work_2_from_date', work_2_to_date	 ='$work_2_to_date', work_2_experience_duration	 ='$work_2_experience_duration', work_2_nature_of_work	 ='$work_2_nature_of_work', work_2_current_job	 ='$work_2_current_job', work_3_experience_type	 ='$work_3_experience_type', work_3_organization_name	 ='$work_3_organization_name', work_3_position	 ='$work_3_position', work_3_from_date	 ='$work_3_from_date', work_3_to_date	 ='$work_3_to_date', work_3_experience_duration	 ='$work_3_experience_duration', work_3_nature_of_work	 ='$work_3_nature_of_work', work_3_current_job	 ='$work_3_current_job', gate_registration_no	 ='$gate_registration_no', gate_paper_code	 ='$gate_paper_code', gate_coap_registration_no	 ='$gate_coap_registration_no', gate_score_out_of_1000	 ='$gate_score_out_of_1000', gate_rank	 ='$gate_rank', gate_valid_from	 ='$gate_valid_from', gate_valid_upto	 ='$gate_valid_upto', gate_notes_if_any	 ='$gate_notes_if_any', payment_method	 ='$payment_method', payment_reference_number	 ='$payment_reference_number', payment_amount	 ='$payment_amount',app_id='$app_id',filled_status=1, added_updated=NOW() where mtech_application_category ='$mtech_application_category' and mtech_department='$mtech_department' and personal_email='$personal_email'"; 
// echo $query;
