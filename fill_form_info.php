...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true || !isset($_SESSION["username"])){
	...
	$id_number="";
    $_SESSION['mtech_application_category']=$_POST['mtech_application_category'];
    $_SESSION['mtech_department']=$_POST['mtech_department'];
    $_SESSION['mtech_is_your_btech_from_iit']=$_POST['mtech_is_your_btech_from_iit'];
    ...
    $user_check_query = "SELECT * FROM `mtp_application_info` WHERE `mtech_application_category`='$mtech_application_category' and `mtech_department`='$mtech_department' and `personal_email`='$personal_email'   LIMIT 1";
		...
		// Finally, register user if there are no errors in the form
			...
			$sql = "INSERT INTO `mtp_application_info` (`id_number`,`personal_email`,`mtech_application_category`, `mtech_department`, `mtech_is_your_btech_from_iit`) values (NULL,'$personal_email','$mtech_application_category', '$mtech_department','$mtech_is_your_btech_from_iit')";
...
<div style="background-color:black; width:320px; position:fixed; height:110%; margin-right:200px; margin-top:-50px">
        <nav class="navbar navbar-expand d-flex flex-column align-item-start" id="sidebar">
            ...
            <li class="nav-item w-100"> 
                    <h2 style="background-color:orange"><a class="nav-link text-light pl=4">Personal Details</a></h2>
                </li>
...
<div style="margin-left:220px">
    ...
    <form action="server_info.php" method="post" onSubmit="alert('Successfully saved')" enctype="multipart/form-data">
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-md-10 offset-md-1">
                        ...
                        <div class="card-body" style="background-color:#D3D3D3">
                            <form class="form" role="form" autocomplete="off">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" value='<?php echo $id_number ?>' pattern="[A-Za-z\s]+"  name="id_number" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Application Catetgory</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" value='<?php echo $mtech_application_category ?>'  name="personal_application_category" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Department </label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" value='<?php echo $mtech_department ?>'  name="personal_department" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Title*</label>
                                    <div class="col-lg-9">
                                        <select id="user_time_zone" class="form-control" size="0" name="personal_title" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" pattern="[A-Za-z\s]+"  name="personal_first_name" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Middle Name</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" pattern="[A-Za-z\s]+"  name="personal_middle_name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Last Name*</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" pattern="[A-Za-z\s]+"  name="personal_last_name" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Alternate Email</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="email"  name="personal_aternative_email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Mother's Name*</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" pattern="[A-Za-z\s]+" value="" name="personal_mothers_name" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <div class="card card-outline-secondary">
                        <div class="card-header">
                            <h3 class="mb-0">Present Details</h3>
                        </div>
                        <div class="card-body" style="background-color:#D3D3D3">
                            <form class="form" role="form" autocomplete="off"> 
                                
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Current Address*</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="personal_address" placeholder="(200 char max) Personal Address" required maxlength="200">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">City*</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="personal_city" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="number" pattern="^[0-9]{6}$" value="" name="personal_pincode" required minlength="6" maxlength="6">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="number" pattern="[4-9]{1}[0-9]{9}" minlength="10" maxlength="10" name="personal_contact" required>
                                    </div>
                                </div>
