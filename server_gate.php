...
$query = "update mtp_application_info set filled_gate = '$filled_gate', gate_registration_no	 ='$gate_registration_no', gate_paper_code	 ='$gate_paper_code', gate_coap_registration_no	 ='$gate_coap_registration_no', gate_score_out_of_1000	 ='$gate_score_out_of_1000', gate_rank	 ='$gate_rank', gate_valid_from	 ='$gate_valid_from', gate_valid_upto	 ='$gate_valid_upto', gate_notes_if_any	 ='$gate_notes_if_any', added_updated=NOW() where mtech_application_category ='$mtech_application_category' and mtech_department='$mtech_department' and personal_email='$personal_email'"; 

header("location: fill_form_work.php");
...
{
	echo '<center><b>Gate Info Form submiitted Successfullly<br><br>Application ID:'.$app_id.'</center>';
  ?>
  <button><a href="fill_form_work.php" class="nav-link text-light pl=4">Work Experience</a></button>
